...
public:
    BankP5() : LBank(6)
    {
        ...
        mem->mod(new K32_mod_fadein)->at(1)->period(50000)->phase(0)->mini(0)->maxi(100);
        ...
        mem->mod(new K32_mod_sinus)->at(1)->period(8500)->phase(0)->mini(100)->maxi(255);
        mem->mod(new K32_mod_sinus)->at(3)->period(5000)->phase(35)->mini(100)->maxi(150); //modulo sur le vert
        mem->mod(new K32_mod_sinus)->at(2)->period(5000)->phase(35)->mini(200)->maxi(100); //modulo sur le rouge        
        add(127, 255, 255, 255, 255, 255); // 05 Super8
        add(255, 255, 000, 255, 000, 000); // 06 Disco color
        mem->mod(new K32_mod_random)->at(2)->period(500)->phase(0)->mini(0)->maxi(255); // modulo r
        mem->mod(new K32_mod_random)->at(3)->period(500)->phase(60)->mini(0)->maxi(255); // modulo g
        mem->mod(new K32_mod_random)->at(4)->period(500)->phase(180)->mini(0)->maxi(255); // modulo b
        add(255, 255, 255, 255, 000, 000); // 07 Jaune
        add(117, 255, 255, 127, 000, 000); // 08 Orange
        add(255, 255, 255, 000, 000, 000); // 09 Rouge strobe
