...
public:
    BankStrobe() : LBank(17)
    {
        ...
        add(mem_t{255, 000, 000, 158, 219, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 10 bleu ciel
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 000, 000, 255, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 11 bleu foncer
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 255, 224, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 12 jaune poussin
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 199, 190, 113, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 13 beige
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 133,  91,  39, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 14 marron
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 142, 212, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 15 vert clair
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 000, 154, 061, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 16 vert sapin
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 186,  99, 025, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 17 ocre
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 226, 123, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 18 orange
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);

        add(mem_t{255, 000, 188, 052, 186, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000, 000}); // 19 violet
        mem->mod(new K32_mod_sinus)->period(10000)->at(0)->phase(0)->mini(127)->maxi(255);
